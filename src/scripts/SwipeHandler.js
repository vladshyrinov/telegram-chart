...
let left = +getComputedStyle(block).left.slice(0, -2);

console.log('blockWrapper', blockWrapper.getBoundingClientRect());
console.log('block', block.getBoundingClientRect());
console.log('blockWrapper', blockWrapper.offsetWidth);
console.log('block', block.offsetWidth);


// setInterval(() => {
//     left += 1;
//     if (left < (blockWrapper.clientWidth - block.clientWidth)) {
